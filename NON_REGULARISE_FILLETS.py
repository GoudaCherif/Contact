...
with XDMFFile(MPI.COMM_WORLD,
              os.path.join(save_dir, "resultats_sans_regularisation_fillets.xdmf"), "w") as xdmf:
...
print("Fichier XDMF avancé sauvegardé : resultats_sans_regularisation_fillets.xdmf")
...
grid_def.save(os.path.join(save_dir, "resultats_deformes_von_mises_fillets.vtu"))
print("Maillage déformé (Von Mises exact) sauvegardé : resultats_deformes_von_mises_fillets.vtu")
